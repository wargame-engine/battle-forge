...
export const UnitCard = (props) => {
  const { unit, data, faction, subfactionId = "none", pinned, showOptions = true, unitOptions, points, weapons, rules, weaponRules, models, embeddedOptions = false, toggler = true, focusView = true, perks, level, setbacks } = props;
  ...
  return (
    <div id={unit.id} className="unit-card" style={{ borderColor: factionColor, pageBreakInside: 'avoid' }}>
      ...
      <div className="unit-card-body">
        ...
        <div style={{ marginBottom: '0.5em' }}>
          <UnitStats models={models} unit={unit} faction={faction} data={data} perks={perks} setbacks={setbacks} options={embeddedOptions ? unitOptions : undefined} />
        </div>
